...
sudo echo '<!DOCTYPE html> <html> <body style="background-color:rgb(260, 220, 230);"> <h1>Welcome to APP-2</h1> <p>Terraform Demo</p> <p>Application Version: V1</p> </body></html>' | sudo tee /var/www/html/app2/index.html
